...
public class AdminController {
    ...
    public String editComment(@PathVariable("id") String id, HttpServletRequest request) {
        Comment comment = commentMapper.selectCommentWithId(Integer.parseInt(id));
        request.setAttribute("contents",comment);
    ...
    @ResponseBody
    public CommentResponseData modifyComment(Comment comment) {
        try {
    ...
    // 评论删除
    @PostMapping(value = "/comment/deleteComment")
    @ResponseBody
